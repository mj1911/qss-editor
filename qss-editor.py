#!/bin/env python3
''' Graphical editor for Qt5 .qss stylesheets 
    Adapted from QSS-Editor++ '''

import sys
from PyQt5 import QtWidgets, QtGui, QtCore
from PyQt5.QtCore import Qt, pyqtSlot
from style import style_sheet  # style.py
from style import about_window_stylesheet
from style import find_window_stylesheet
import webbrowser


cs = False  # two global checks for QtCore.Qt.Checked?
wwo = False
find_text = ""
...
class FindWindow(QtWidgets.QDialog):
    ...
    def initUI(self):
# define some control geometries
...
class AboutWindow(QtWidgets.QDialog):
    ...
    def initUI(self):
        ...
        text = QtWidgets.QLabel(
            """<html><b>QSS Editor for Flex GUI</b><br><br>
QSS Editor is a tool to edit and preview<br>
Qt stylesheets.  It contains 30 of the most<br>
common Qt widgets in various states.<br><br>
You can either open an existing stylesheet to<br>
edit and preview or write one from scratch.<br>
To apply changes to the preview widgets<br>
simply press 'Ctrl+ Enter' or click 'Apply'<br>
from the 'View' menu bar.<br><br>
(C) 2019 Niklas Henning, 2024 RDTSC/mj1911</html>""",
            self,
        )
        text.setGeometry(30, 10, 300, 195)
        text.setFont(font1)
        text.show()
...
class Highlighter(QtGui.QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        keywords_settings = [ "\\bbackground\\b", "\\bbackground-color\\b",
            "\\bselection-background-color\\b", "\\bmargin\\b",
            "\\bpadding\\b", "\\bpadding-left\\b", "\\bpadding-right\\b",
            "\\bpadding-top\\b", "\\bpadding-bottom\\b", "\\bborder\\b",
            "\\bborder-style\\b", "\\bborder-color\\b", "\\bborder-radius\\b",
            "\\bborder-width\\b", "\\bfont-size\\b", "\\bopacity\\b",
            "\\bimage\\b", "\\bmin-height\\b", "\\bheight\\b",
            "\\bsubcontrol-position\\b", "\\bsubcontrol-origin\\b",
            "\\bwidth\\b", "\\bheight\\b", "\\btext-align\\b", "\\bspacing\\b",
            "\\bmargin-left\\b", "\\bmargin-right\\b", "\\bmargin-top\\b",
            "\\bmargin-bottom\\b", "\\bborder-bottom-style\\b", "\\btop\\b",
            "\\bborder-top-left-radius\\b", "\\bborder-top-right-radius\\b",
            "\\bcolor\\b", "\\bgridline-color\\b", "\\bbottom\\b",
            "\\bleft\\b", "\\bright\\b", "\\balternate-background-color\\b",
            "\\bselection-color\\b", "\\bshow-decoration-selected\\b",
            "\\bposition\\b", "\\bmin-width\\b", 
            "\\bmessagebox-text-interaction-flags\\b", 
            "\\blineedit-password-character\\b", "\\bfont\\b",
            "\\bbutton-layout\\b", "\\boutline\\b", 
            "\\bbtitlebar-normal-icon\\b", "\\btitlebar-close-icon\\b",
            "\\bqproperty-drawBase\\b", "\\btitlebar-normal-icon\\b",
            "\\bdisplay\\b", "\\bpaint-alternating-row-colors-for-empty-area\\b",
            "\\bicon-size\\b", "\\bstop\\b", "\\bmessagebox-warning-icon\\b",
            "\\bmessagebox-question-icon\\b", "\\bmessagebox-information-icon\\b",
            "\\bmessagebox-critical-icon\\b", 
        ]
        ...
        self.highlightingRules = [
            (QtCore.QRegExp(pattern), keywords_settings_format)
        ...
        self.highlightingRules.append(
            (QtCore.QRegExp("\\bQLinearGradient\\b"), exceptions_format)
        )
...
# QRect has changed in recent Qt to QtRectF
...
class MainWindow(QtWidgets.QMainWindow):  # ********** MainWindow ***********
    ...
    def initUI(self):
        ...
        self.current_file = ""
# this window is maximized, not resizeable at all, and divider immovable...
...
# this preview area is where the .ui controls are drawn...
...
# perhaps line number
        ...
        self.command_link_button2 = QtWidgets.QCommandLinkButton(
            " Disabled CommandLinkButton", self
        )
        ...
        self.command_link_button1 = QtWidgets.QCommandLinkButton(
            " Enabled CommandLinkButton", self
        )
        ...
        self.text_edit1 = QtWidgets.QTextEdit("Active Text Edit", self)
        self.text_edit1.setGeometry(1125, 310, 140, 90)
        self.text_edit1.show()

        self.text_edit2 = QtWidgets.QTextEdit("Disabled Text Edit", self)
        ...
        self.plain_text_edit2 = QtWidgets.QPlainTextEdit(
            "Disabled Plain Text Edit", self)
        ...
        self.ldc_number2.display(12345)
        ...
        self.textbrowser1.setText(
            "<html><b>Text</b</html> <html><u>browser</u</html> "
        ...
        self.textbrowser2.setText(
            "Disabled <html><b>Text</b</html> <html><u>browser</u</html> "
            '<html><i>with</i</html> <a href="http://www.google.com">link</a>')
    ...
    def open_changelog(self):
        webbrowser.open(
            "https://github.com/mj1911/qss-editor/blob/master/changelog.txt" )
    ...
    def open_file(self):
        self.file_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, 
            "", "", "QSS File (*.qss)" )
# return if Linux/MacOS (this could fail for a number of reasons)
...
# else Windows
    ...
    def save_as_file(self):
        self.file_name_save, _ = QtWidgets.QFileDialog.getSaveFileName(
            self, "", "", "QSS File (*.qss)" )
        if not self.file_name_save:
            return False
    ...
    def find_(self):
        ...
        def handle_find():
            ...
            del replace_text  # unused?

            cursor = self.text_edit.textCursor()
            del cursor  # unused?

            flags = QtGui.QTextDocument.FindFlags()
# the following seems very repetitive
            # updated conditional testing to modern style
